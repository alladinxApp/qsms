...
<body>
	...
	<table width="2105">
		...
		<tr>
			...
			<td style="<?=$bg . $color;?>"><a href="jobclock.php?worefno=<?=$rowservices['wo_refno'];?>"><? if(!$rowservices['wo_refno'] == 0){ echo $rowservices['wo_refno']; } ?></a></td>
