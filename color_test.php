...
//$bgcolor="#f1f1f1";
echo "<TABLE><tr>";
echo "<th width='75px'><a href='$page_name?column_name=color_id'>Color Code</a></th>";
echo "<th width='120px'><a href='$page_name?column_name=color'>Vehicle Color Description</a></th>";
...
echo "<td width='110px'><center><a href='color_edit.php?id=$row[color_id]'><img src='images/edit.png' /> &nbsp;&nbsp; <img src='images/delete.png' /></center></td>"; 
