...
<body>
	<p id="title">Service Type Summary Report Result</p>
	<? if(isset($_POST['export']) && !empty($_POST['export']) && $_POST['export'] == 1){ ?>
	...
	<input type="hidden" id="txtjob" name="txtjob" value="<?=$cust;?>">
	<table width="100%">
		<tr>
	...
	<table width="510">
		...
		<tr>
			<td align="right" colspan="3" style="<?=$style;?> border: 0;">Total Customers >>>>></td>
			<td align="right" style="<?=$style;?> border: 0;"><?=$totalunits;?></td>
		</tr>
	</table>
	</div>
