<?
	...
	$qrybillingmst = "SELECT * FROM v_billing_master";
...
<body>
	...
	<table width="600">
		<tr>
			<th width="10">#</th>
			<th width="200">Billing Ref#</th>
			<th width="200">Billing Date</th>
		...
		<tr>
			...
			<td><a href="billing_for_posting.php?billingrefno=<?=$rowBILLINGMST['billing_refno'];?>"><?=$rowBILLINGMST['billing_refno'];?></a></td>
			<td align="center"><?=dateFormat($rowBILLINGMST['billing_date'],"F d, Y");?></td>
			<td align="right"><?=number_format($rowBILLINGMST['total_billing'],2);?></td>
		</tr>
		<? $cnt++; } ?>
	</table>
	</div>
