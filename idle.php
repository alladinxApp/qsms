...
<p id="title">IDLE TIME PREPARATION</p>
	...
	<table>
		<tr>
			...
			<td class ="input"><input type="text" name="model2" value="" readonly style="width:235px"></td>
			<td></td>
			<td class ="label"><label name="lbl_customer">Customer Name:</label></td>
			<td class ="input"><input type="text" name="model3" value="" readonly style="width:295px"></td>
		</tr>
	</table>
	</span>
</fieldset>
...
<fieldset form="form_highschool" name="form_highschool">
  ...
  <p id="title">idle CLOCK :</p></legend>
	...
	<table width="747">
		<tr>
			<td width="12" height="60" class ="label">&nbsp;</td>
			<td width="175" class ="input">CREATE A SYSTEM DATE HERE (MONTH DAY AND YEAR)</td>
			<td width="180"><span class="input">CREATE SYSTEM TIME HERE (CLOCK)</span></td>
			<td width="175" class ="label">&nbsp;</td>
			<td width="109" class ="input">
		    <td width="46"></td>
		...
		<tr>
			...
			<td class ="input"><a href="idlepick.php"><img src="images/idle start.png" width="169" height="50"></a></td>
			<td>&nbsp;</td>
			<td class ="label">&nbsp;</td>
			<td class ="input">&nbsp;</td>
			<td></td>
