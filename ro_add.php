...
<body>
	...
	<table>
		<tr>
			<td class ="label"><label name="lbl_parts_id">RO Reference No:</label>
			<td class ="input"><input type="text" name="parts_id" value="[SYSTEM GENERATED]" readonly style="width:272px"></td>
		</tr>
		<tr>
			<td class ="label"><label name="lbl_parts">Supplier:</label>
			<td class ="input"><select name="supplier" id="supplier">
				<option value="">-- Select Supplier --</option>
			</select></td>
		</tr>
		<tr>
			<td class ="label"><label name="lbl_parts_discount">Deliver To:</label>
		...
		<tr>
			<td class ="label"><label name="lbl_part_srp">Payment Term:</label>
		...
		<tr>
			<td class ="label"><label name="lbl_part_onhand">Discount:</label>
