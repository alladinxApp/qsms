...
<body>
	<p id="title">OINV Report</p>
	<form method="Post" onSubmit="return valMe();" action="oinv_report_result.php" target="_blank">
	...
	<input type="hidden" id="report" name="report" value="oinvreport" />
	</form>
