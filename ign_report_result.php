...
<body>
	<p id="title">IGN Report Result</p>
	<? if(isset($_POST['export']) && !empty($_POST['export']) && $_POST['export'] == 1){ ?>
	...
	<table width="1350">
		...
		<tr>
			<td style="<?=$style;?>">1</td>
			<td align="center" style="<?=$style;?>"><?=$cnt;?>0</td>
			<td align="center" style="<?=$style;?>"><?=$row['SAP_item_code'];?>sp</td>
			<td align="center" style="<?=$style;?>"><?=$row['item_description'];?>id</td>
			<td align="center" style="<?=$style;?>"><?=$row['quantity'];?>qty</td>
			<td align="center" style="<?=$style;?>"></td>
			<td align="right" style="<?=$style;?>"><?=number_format($row['price'],2);?>pr</td>
			<td align="center" style="<?=$style;?>"></td>
			<td align="center" style="<?=$style;?>"></td>
			<td align="center" style="<?=$style;?>"></td>
			<td align="center" style="<?=$style;?>"></td>
	...
	<input type="hidden" id="report" name="report" value="ignreport" />
	</form>
	<? } ?>
</body>
</html>