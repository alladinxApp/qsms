	...
	class PrintPO extends FPDF{
		...
		public function ImprovedTable(){
			...
			for($i=0;$i<count($this->dtl);$i++){
				...
				$this->Cell(30,4,$this->dtl[$i]['price'],"LR",0,'R');
				$this->Cell(20,4,$this->dtl[$i]['qty'],"LR",0,'C');
				$this->Cell(30,4,$this->dtl[$i]['total'],"LR",0,'R');
				$this->Ln();
			...
			$this->SetFont('Courier','',8);
			$this->Cell(30,4,$this->mst['sub_total'],0,0,'R');
			$this->Ln();
			...
			$this->SetFont('Courier','',8);
			$this->Cell(30,4,$this->mst['discount'],0,0,'R');
			$this->Ln();
			...
			$this->SetFont('Courier','',8);
			$this->Cell(30,4,$this->mst['vat'],0,0,'R');
			$this->Ln();
			...
			$this->SetFont('Courier','',8);
			$this->Cell(30,6,$this->mst['total_amount'],"T",0,'R');
			$this->Ln();
		}
