...
$(function(){
	...
	$('#birthday').bind(
		...
		function(e, selectedDates)
		{
			...
			if (d) {
				d = new Date(d);
				$('#birthday').dpSetStartDate(d.addDays(0).asString());
			}
		}
	);
</script>
...
<form method="post" name="customer_form" class="form" onSubmit="return ValidateMe();">
	...
	<legend>
	<p id="title">SUPPLIER Masterfile</p></legend>
	<table>
		<tr>
			<td class ="label"><label name="lbl_cust_id">Supplier  Code:</label>
		...
		<tr>
			...
			<td class ="input"><input type="text" name="birthday" id="birthday" value="" class="date-pick" readonly style="width:91px"></td>
		</tr>
		<tr>
