<?
	...
	if($numchkcheckinout > 0){
		$sql = "UPDATE tbl_jobclock_checkin_checkout SET check_out = '$today' WHERE wo_refno = '$worefno'";
	}else{
		$sql = "INSERT INTO tbl_jobclock_checkin_checkout(check_out) VALUES('$today')";
	}
	$qry = mysql_query($sql);
...
<table>
	...
	<tr>
		...
		<?
			...
			$to_time = strtotime($rowCHECKINOUT['check_out']);
