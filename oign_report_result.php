...
<body>
	<p id="title">OIGN Report Result</p>
	<? if(isset($_POST['export']) && !empty($_POST['export']) && $_POST['export'] == 1){ ?>
	...
	<table width="1350">
		...
		<tr>
			...
			<td style="<?=$style;?>"></td>
			<td style="<?=$style;?>"></td>
			<td align="center" style="<?=$style;?>"><?=dateFormat($row['billing_date'],"m/d/Y");?>date</td>
			<td align="center" style="<?=$style;?>"><?=dateFormat($row['billing_date'],"m/d/Y");?>date</td>
			<td style="<?=$style;?>"></td>
			<td style="<?=$style;?>"></td>
			<td style="<?=$style;?>"></td>
			<td style="<?=$style;?>"></td>
			<td align="right" style="<?=$style;?>"><?=number_format($row['billing_amount'],2);?>ba</td>
			<td style="<?=$style;?>"></td>
			<td style="<?=$style;?>"></td>
			<td style="<?=$style;?>"></td>
			<td style="<?=$style;?>"></td>
	...
	<input type="hidden" id="report" name="report" value="oignreport" />
	</form>
	<? } ?>
</body>
</html>