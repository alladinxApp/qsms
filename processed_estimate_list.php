...
<body>
	...
	<p id="title">Processed Estimate LIST</p>
	...
	<table width="2200">
		...
		<tr>
			...
			<td style="<?=$bg . $color;?>"><a style="<?=$color;?>" href="estimate_print.php?estimaterefno=<?=$rowservices['estimate_refno'];?>"><?=$rowservices['estimate_refno'];?></td>
	...
	<? }else{ ?>
	<form method="Post" >
	<p id="title">Search Processed Estimate LIST</p>
