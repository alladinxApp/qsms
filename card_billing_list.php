<?
	...
	chkMenuAccess('card_billing',$_SESSION['username'],'billing_list.php');
	
	$qrybillingmst = "SELECT * FROM v_card_billing WHERE transaction_counts > 0";
...
<body>
	...
	<table width="600">
		...
		<tr>
			...
			<td><a href="billing_details.php?custid=<?=$rowBILLINGMST['cust_id'];?>&type=2"><?=$rowBILLINGMST['cust_id'];?></a></td>
