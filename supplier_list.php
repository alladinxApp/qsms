...
Search by Customer Name: <input type="text" name="txtsearchcust" id="txtsearchcust" name="search" placeholder="Enter Supplier Name" /><input type="button" value="Search" onClick="SearchCustomer();" />
